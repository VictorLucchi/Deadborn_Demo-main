import basementKeyImage from '../../assets/items/chave/chave_porao.png';
...
export class GameMap {
    constructor(mapData, tilesetImages) {
        ...
        this._objectSortY =
            this._buildSortYMap('objects');

        this._objectFrontSortY =
            this._buildSortYMap('objects_front');

        // ============================================================
        // CHAVE DO PORÃO
        // ============================================================

        this._basementKeyImage =
            new Image();

        this._basementKeyImage.src =
            basementKeyImage;

        this._basementKeySpawn =
            this._findBasementKeySpawn();
    }
    ...
    getBasementKeyRenderables(
        ...
        if (
            ...
            !this._basementKeySpawn ||
            !this._basementKeyImage ||
            !this._basementKeyImage.complete ||
            !this._basementKeyImage.naturalWidth
        ) {
            return [];
        }
        ...
        const height =
            width *
            (
                this._basementKeyImage.naturalHeight /
                this._basementKeyImage.naturalWidth
            );
